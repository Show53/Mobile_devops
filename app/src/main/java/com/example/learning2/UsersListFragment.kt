...
class UsersListFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = UsersListAdapter(testData1, object : UsersListAdapter.OnItemClickListener {
            override fun onItemClick(item: UsersListItem) {
                val fragment = UsersItemDetailFragment.newInstance(item)
